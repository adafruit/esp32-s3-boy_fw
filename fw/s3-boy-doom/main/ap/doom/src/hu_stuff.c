...
static player_t*	plr;
EXT_RAM_BSS_ATTR patch_t*		hu_font[HU_FONTSIZE];
static hu_textline_t	w_title;
boolean			chat_on;
static hu_itext_t	w_chat;
static boolean		always_off = false;
EXT_RAM_BSS_ATTR static char		chat_dest[MAXPLAYERS];
EXT_RAM_BSS_ATTR static hu_itext_t w_inputbuffer[MAXPLAYERS];

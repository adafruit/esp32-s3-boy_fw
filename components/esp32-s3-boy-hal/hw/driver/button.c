...
{
  {GPIO_NUM_18, _DEF_LOW, _DEF_HIGH}, // 0. BTN_LEFT
  {GPIO_NUM_17, _DEF_LOW, _DEF_HIGH}, // 1. BTN_RIGHT
  {GPIO_NUM_16, _DEF_LOW, _DEF_HIGH}, // 2. BTN_UP
  {GPIO_NUM_15, _DEF_LOW, _DEF_HIGH}, // 3. BTN_DOWN
  {GPIO_NUM_14, _DEF_LOW, _DEF_HIGH}, // 4. BTN_A
  {GPIO_NUM_8 , _DEF_LOW, _DEF_HIGH}, // 5. BTN_B
  {GPIO_NUM_37, _DEF_LOW, _DEF_HIGH}, // 6. BTN_X
  {GPIO_NUM_12, _DEF_LOW, _DEF_HIGH}, // 7. BTN_Y
  {GPIO_NUM_11, _DEF_LOW, _DEF_HIGH}, // 8. BTN_START
  {GPIO_NUM_10, _DEF_LOW, _DEF_HIGH}, // 9. BTN_SELECT
  {GPIO_NUM_9 , _DEF_LOW, _DEF_HIGH}, // 10.BTN_HOME
};
